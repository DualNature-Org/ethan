...
function Navbar() {
  ...
  return (
    <div>
      ...
      <nav className='hidden sm:flex justify-between bg-white text-slate-500 ' style={{backgroundColor: '#0B3F67', padding: '.6rem', borderBottom: 'solid 2px black', boxShadow: '10px 5px 5px red;'}}>
        <Link to="/">
          <div className='flex justify-center items-center'>
            <img src={Logo} alt="logo" className='w-16 h-16 md:w-25 md:h-25 rounded-full' />
            <h1 className='text-2xl md:text-2xl font-bold font-mono' style={{marginLeft: '.6rem', color:'antiquewhite', fontSize: '1.8rem'}}>Ethan School</h1>
          </div>
        </Link>
      ...
      <nav className='sm:hidden flex justify-between items-center bg-[#0B3F67] text-white py-2 px-2'>
        <a href="/">
