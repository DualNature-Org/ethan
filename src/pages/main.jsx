  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center flex-col flex-wrap m-4 md:m-10'>
        ...
        <div className='m-0 md:flex justify-around items-center  md:m-7  mb-10 flex-wrap' style={{margin: '-0.5rem'}}>
          <Reveal triggerOnce>
      ...
      <div className='flex flex-col justify-center items-center' >
        <h1 className='text-xl m-2 font-semibold  'style={{fontFamily: 'cursive', fontSize: '1.6rem'}}>Our Infrastructure</h1>
      ...
      <div className='flex flex-col justify-center items-center'>
      <h1 className='text-xl m-2 font-semibold  ' style={{fontFamily: 'cursive', fontSize: '1.6rem', marginTop: '2rem'}}>Students at Ethan</h1>
      ...
      <div className='m-2 py-8 px-8'>
        <div className='flex justify-center items-center flex-wrap'>
          <h1 className='font-bold text-3xl flex flex-col text-[#0B3F67] justify-center items-center  md:text-6xl mb-10'>Our Purpose<img src={as1} alt="as1" /></h1>
          <div className='flex flex-col justify-center items-center'>
      ...
      <AttentionSeeker>
        <div className='flex justify-center items-center flex-col  m-4 md:m-10 mt-15'>
          <div className='flex justify-center items-center flex-wrap' style={{marginBottom: '-4rem'}}>
          ...
          <div className='flex justify-around items-center m-4 md:m-20  flex-wrap'>
            ...
            <img src={Coma} alt="coma" className='w-[7rem] h-[7rem] ml-[11rem]  mb-0 mt-8 md:w-[9rem] md:h-[9rem] md:m-0  md:mb-28  md:mt-[3rem] pl-10 rounded-full' />
          </div>
        </div>
      </AttentionSeeker>
    </div>
